...
<head>
    ...
    <style>
        #jumbotron1{
            background-image: url(../../../images/consultation/highSchool/highScList.jpg);
...
<div class="container">
    ...
    <div class="alert alert-secondary" role="alert">
        <strong><span style="color: #1180ed">所在位置：</span></strong><span style="color: #1180ed">e学慕课/烟台市高中</span>
    </div>
    ...
    <div class="col-md-12" >
        <table id="table" class="table-borderless table-hover table-striped" data-height="500" style="padding-top:20px">
        </table>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var columns=[{
        ...
        formatter:function (value ,row ,index) {
            return [
                '<a href=\''+'highScfroPage/'+row.id+'\'target="view_window">'+row.schoolName+'</a>'
            ].join("");
        }
    }, {
        field: 'websiteUrl',
    ...
    function initTable() {
        ...
        $('#table').bootstrapTable({
            ...
            url:prefix+"highSchool/highSchoolList",        // 请求后台的URL（*）
