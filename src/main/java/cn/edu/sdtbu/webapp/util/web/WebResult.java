...
public class WebResult extends HashMap<String, Object>
{
    ...
    /**
     * 初始化一个新创建的 WebResult 对象，使其表示一个空消息。
     */
    public WebResult()
    {
    }
    ...
    /**
     * 初始化一个新创建的 WebResult 对象
     * 
     * @param type 状态类型
     * @param msg 返回内容
     */
    public WebResult(Type type, String msg)
    {
     ...
     * @param data 数据对象
     */
    public WebResult(Type type, String msg, Object data)
    {
        super.put(CODE_TAG, type.value);
        super.put(MSG_TAG, msg);
    ...
    {
        return new WebResult(Type.SUCCESS, msg, data);
    }
     ...
     * @return 警告消息
     */
    public static WebResult warn(String msg)
    {
        return WebResult.warn(msg, null);
    }
     ...
     * @return 警告消息
     */
    public static WebResult warn(String msg, Object data)
    {
        return new WebResult(Type.WARN, msg, data);
    }
    ...
    {
        return new WebResult(Type.ERROR, msg, data);
    }
